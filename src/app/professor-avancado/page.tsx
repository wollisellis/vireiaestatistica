...
export default function ProfessorAvancadoPage() {
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h2 className="text-2xl font-bold mb-2">
                            Bem-vindo ao Dashboard Avançado!
                          </h2>
                          <p className="text-indigo-100">
                            Gerencie suas turmas, monitore o progresso dos estudantes e configure módulos com ferramentas avançadas.
                          </p>
                        </div>
