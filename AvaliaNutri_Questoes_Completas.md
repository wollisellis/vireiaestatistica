# AvaliaNutri - Questões e Conteúdo Educacional Completo

## 📋 Resumo Executivo

**Plataforma:** AvaliaNutri - Sistema educacional de avaliação nutricional  
**Instituição:** UNICAMP - Ciências da Saúde - Nutrição  
**Modalidade:** Presencial com suporte digital  
**Total de Módulos:** 4  
**Total de Exercícios:** 19  
**Total de Questões Específicas:** 4  
**Pontuação Total:** 3.860 pontos  
**Tempo Estimado:** 540 minutos (9 horas)  
...
#### 1.3 Importância do Diagnóstico Nutricional
...
##### Questão 1.1.1
**Pergunta:** Qual dos seguintes NÃO é um componente da avaliação nutricional individual?
...
**Penalidade por Hint:** 10 pontos

##### Questão 1.1.2
**Pergunta:** Segundo dados do SISVAN 2023, qual a prevalência de obesidade em adultos brasileiros?
...
#### Exercício 1.3: Classificação de Componentes
- **Tipo:** Drag and Drop
- **Pontos:** 150
- **Dificuldade:** Médio
...
**Tarefa 1.1:** Quais dados antropométricos você deve coletar nesta primeira consulta?
- **Tipo:** Diagnosis
- **Campos Obrigatórios:** weight, height, waistCircumference
- **Pontos:** 50

### 📊 Dados Reais - Módulo 1
...
*Tipo:* Imagem  
*Conteúdo:* Imagem comparativa dos diferentes métodos de avaliação  
*URL da Mídia:* /images/body-composition-methods.png
...
#### Exercício 2.2: Simulador de Custo-Benefício
- **Tipo:** Calculation
- **Pontos:** 180
- **Dificuldade:** Médio
...
##### Questão 2.3.1
**Pergunta:** Um paciente realizou DEXA e apresentou 32% de gordura corporal. Considerando que é um homem de 35 anos, como você classificaria?
...
*Tipo:* Interactive  
*Conteúdo:* interactive-3d-anatomical-points
...
##### Questão 3.3.1
**Pergunta:** Segundo a POF 2024, qual o IMC médio da população adulta brasileira?
...
#### 4.4 Calculadora de Diagnóstico Integrado
*Tipo:* Interactive  
*Conteúdo:* interactive-integrated-calculator
...
**Tarefa 4.1:** Calcule o IMC e classifique o estado nutricional atual
- **Tipo:** Calculation
- **Campos Obrigatórios:** bmi, classification
- **Pontos:** 100

**Tarefa 4.2:** Qual o percentual de perda de peso e sua significância clínica?
- **Tipo:** Interpretation
- **Campos Obrigatórios:** weightLossPercentage, clinicalSignificance
- **Pontos:** 100

**Tarefa 4.3:** Elabore o diagnóstico nutricional integrado e plano de intervenção
- **Tipo:** Diagnosis
- **Campos Obrigatórios:** diagnosis, interventionPlan
- **Pontos:** 100

#### Exercício 4.2: Calculadora Integrada
- **Tipo:** Calculation
- **Pontos:** 150
- **Dificuldade:** Médio
...
### Distribuição de Pontos por Módulo
- **Módulo 1:** 650 pontos (16,8%)
- **Módulo 2:** 680 pontos (17,6%)
- **Módulo 3:** 980 pontos (25,4%)
- **Módulo 4:** 1.550 pontos (40,2%)

### Distribuição por Tipo de Exercício
- **Quiz:** 4 exercícios (480 pontos)
- **Case Study:** 4 exercícios (1.150 pontos)
- **Brazilian Data:** 4 exercícios (810 pontos)
- **Collaborative:** 2 exercícios (550 pontos)
- **Interactive:** 2 exercícios (350 pontos)
- **Calculation:** 2 exercícios (280 pontos)
- **Matching:** 1 exercício (120 pontos)
- **Drag Drop:** 1 exercício (150 pontos)

### Distribuição por Dificuldade
- **Fácil:** 4 exercícios (570 pontos) - 21,1%
- **Médio:** 11 exercícios (2.240 pontos) - 57,9%
- **Difícil:** 4 exercícios (1.130 pontos) - 21,1%

### Fontes de Dados Reais Brasileiros
...
5. **HC-UNICAMP** (Hospital das Clínicas da UNICAMP)
...
- ✅ Distinguir avaliação individual vs populacional
- ✅ Aplicar conceitos básicos de diagnóstico nutricional

### Módulo 2: Métodos de Avaliação
- ✅ Comparar métodos de composição corporal
- ✅ Analisar custo-benefício de diferentes técnicas
- ✅ Interpretar resultados de DEXA, bioimpedância e antropometria

### Módulo 3: Técnicas Antropométricas
- ✅ Dominar técnicas corretas de medição
- ✅ Identificar e evitar erros comuns
- ✅ Aplicar dados populacionais brasileiros

### Módulo 4: Diagnóstico Integrado
- ✅ Integrar múltiplos indicadores nutricionais
- ✅ Elaborar diagnósticos nutricionais complexos
- ✅ Desenvolver planos de intervenção baseados em evidências

---

**Documento gerado automaticamente da plataforma AvaliaNutri**  
**Data de extração:** 2025-07-16  
**Versão do sistema:** 1.0  
**Total de conteúdo educacional:** 4 módulos, 19 exercícios, 4 questões específicas